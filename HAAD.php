...
<section>
    <div class="header-image-full">
        <img src="assets/slider/HAAd-Coaching--in-Thrissur (1).jpg" class="img-fluid" alt="...">
    </div>
</section>
<!-- Mobile View -->
<section>
        ...
        <div class="row mobile-row">
            <div class="col-8 p-6 text-white ">
                <div class="text-black-content">
                    ...
                    <p>The Health Authority of Abu Dhabi (HAAD) is a model organization that grants licenses to medical professionals through the HAAD Exam so they can work in any area of healthcare inside the Emirate of Abu Dhabi. Prior to working in any healthcare industry in Abu Dhabi, all healthcare professionals must receive their license. The license must be current, valid, and renewed three months before it expires while the practitioner is using it. The healthcare industry that a health professional works for is truly connected to their licensing. Physicians from the UAE who are employed in the Emirate of Abu Dhabi may simultaneously practice in the public and private sectors.</p>
                    ...
                    <div class="text-black-content-left">
                        ...
                        <p class="active"><a href="HAAD.php">HAAD</a></p>
                ...
                <div class="accordion" id="accordionExample">
                  ...
                  <div class="accordion-item">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        A candidate can attend the HAAD examination three times in his/her lifetime.
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item">
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        Yes, it is possible to convert the data flow procedures from HAAD to DHA / MOH. After completing the data flow and credentialing process, the candidate should take the required test (DHA/MOH).
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item">
                    ...
                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        If a candidate has passed the HAAD exam; after working in Abu Dhabi for six months, he/she can convert to DHA or MOH licence without attending the DHA / MOH exam.
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item">
                    ...
                    <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        <strong>The total duration of HAAD exam is two and half hours and there is a total of 100 Multiple Choice Questions in the test. The different processes involved in HAAD exam are:</strong>
                        <ol>
                            <li>Credential</li>
                            <li>Data Flow</li>
